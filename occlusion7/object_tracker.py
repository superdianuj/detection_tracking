...
def Object_tracking(Yolo, video_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors='', Track_only = []):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            class_name = track.cls #Get the class name of particular object
...
Object_tracking(yolo, video_path, fil_name+"_detected.mp4" , input_size=YOLO_INPUT_SIZE, show=False, iou_threshold=0.1, rectangle_colors=(255,0,0), Track_only = ["person"])
