...
def init_tracker():
    ...
    deepsort= DeepSort(cfg_deep.DEEPSORT.REID_CKPT,
                            ...
                            max_age=cfg_deep.DEEPSORT.MAX_AGE+300, n_init=cfg_deep.DEEPSORT.N_INIT+80, nn_budget=cfg_deep.DEEPSORT.NN_BUDGET,
                            use_cuda=True)
...
class SegmentationPredictor(DetectionPredictor):
    ...
    def postprocess(self, preds, img, orig_img):
        ...
        # Filter by classes (only keep humans)
        p = [pred[pred[:, 5] == 0] for pred in preds[0]]  # Assuming class 0 is humans
